...
const VideoPage = ({ id,props }) => {
    ...
    return (
        <div style={{  marginTop: '80px' }}>
            {/* <iframe width="1000" height="605" src="https://www.youtube.com/embed/cNE7-gxclO4" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe> */}
            {
                result.map(item =>
